  ...
  return (
    <article className='bg-mywhite rounded-br flex flex-col items-center p-4 h-[500px]'>
                                ...
                                <form className='flex flex-col w-full px-8 mt-4 gap-1' dir='rtl' onSubmit={(e)=>e.preventDefault()}>
                                    ...
                                    <div className='border-b-2 border-t-0 border-x-0 border-myprimary-200 p-2 focus:border-myprimary-100 w-1/2'>
                                    <Dropdown label='' inline={true} color='purple' size='sm'>
                                        <Dropdown.Item >کیف</Dropdown.Item>
                                        <Dropdown.Item >کفش</Dropdown.Item>
                                        <Dropdown.Item >لباس</Dropdown.Item>
                                        <Dropdown.Item >مجلسی</Dropdown.Item>
                                        <Dropdown.Item >زمستانی</Dropdown.Item>
                                        <Dropdown.Item >اکسسوری</Dropdown.Item>
                                        <Dropdown.Item >ورزشی</Dropdown.Item>
                                    </Dropdown>
                                    </div>
                                    </div>
