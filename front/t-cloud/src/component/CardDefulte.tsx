        ...
        return (
            ...
            <div className="bg-mywhite border-[1px] border-myprimary-100 overflow-hidden group w-32 h-56 sm:w-52 sm:h-80 rounded-xl">
              <img src={props.url} alt={props.brand} className='object-cover object-center h-full'/>
                ...
                <div className='bg-white translate-y-[-520px] w-full h-full opacity-0 group-hover:opacity-100 group-hover:bg-opacity-50 flex justify-center items-center pt-24'>
                <Button color="purple">select option</Button>
                </div>
            </div>
            </>
        )
